...
task2_preprocessing.png - Original vs Grayscale images
task3_enhancement.png - Restoration pipeline (6 stages)
task4_segmentation.png - Segmentation & morphology (6 results)
task5_features.png - Edge detection & features (4 methods)
task7_pipeline_visualization.png - Complete 6-stage pipeline
🔬 Technical Details
...
Q: Can I use my own images? A: Yes! Modify the image_path variable in main.py to point to your image file.

Q: What image formats are supported? A: JPEG, PNG, WebP, BMP, TIFF, and most common formats supported by OpenCV.

Q: How can I adjust parameters? A: Each task module has adjustable parameters (kernel sizes, thresholds, etc.) that can be modified.

Q: Can this work on GPU? A: Currently CPU-based. GPU acceleration can be added using CUDA/CuPy.
